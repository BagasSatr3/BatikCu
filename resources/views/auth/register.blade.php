...
<div class="vh-100">
  <div class="row title-home1 vh-100">
    <div class="col-4 title-home1 d-flex flex-column align-items-center justify-content-center">
      <div class="m-5">
        <div class="mt-4 text-center">
          <h1 style="color: #DDA15E;"> <strong> Welcome Back! </strong></h1>
        </div>
        <div class="mt-2 mb-5 text-center">
          <p style="color: #DDA15E;">To keep connected with us please login with your personal info</p>
        </div>
    ...
    <div class="col title-home2 vh-100 d-flex flex-column align-items-center justify-content-center">
      <div class="">
              ...
              <div class="">
                ...
                <div class="form-group mb-4">
                  <div class="mb-5 text-center">
                    <h1 style="color: #DDA15E;"> <strong> Create Account </strong></h1>
                  </div>
                ...
                <div class="form-group d-flex flex-column align-items-center">
                  <button type="submit" class="btn btn-primary mb-4 regis">Register</button>
                  <p>Sudah punya akun? Login <a href="{{ route('login') }}" class="text-decoration-none">disini</a></p>
                </div>
              </div>
            </div>
