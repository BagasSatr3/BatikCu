...
<div class="container">
    <div class="rounded ">
        <div class="row justify-content-center title-home1">
            <div class="col-mt-4 ">
                <h2 class=" text-center mt-3" style="color: #DDA15E;">Create Account</h2>
                        @if(count($errors) > 0)
                        @foreach($errors->all() as $error)
                            <div class="alert alert-warning">{{ $error }}</div>
                        @endforeach
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                <div class="col" style="color: #DDA15E;">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name">Nama</label>
                                        <input type="text" name="name" id="name" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn title-home2 rounded-pill">
                                            <h6 style=" color: #414B3B;">Register</h6>
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<div class="col title-home2 ">
    <div class="mt-5" style="color: #414B3B;">
        <div class="mt-4 text-center">
            <h1 class="" style="">Welcome Back!</h1>
        </div>
        <div class="mt-2 mb-2 text-center">
            <p style="">To keep connected with us please login with your personal info</p>
        </div>
